...
/**
 *	This is the file that the SSO redirects to when an existing user has registered 
 *
...
if($_SERVER['REQUEST_METHOD'] != 'GET'){
	echo "Incorrect HTTP method. ChangePasswordResult only supports GET";
	throw new Exception();
	exit();
}

$ssoService = new RegistrationService();
echo $ssoService->EndResetPassword();
