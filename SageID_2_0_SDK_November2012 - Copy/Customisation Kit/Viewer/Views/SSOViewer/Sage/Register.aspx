<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Template.Master" Inherits="System.Web.Mvc.ViewPage<RegisterModel>" %>

<%@ Import Namespace="WebSignOn.Application" %>
<%@ Import Namespace="Resources" %>
<asp:Content ID="titleContent" ContentPlaceHolderID="TitleContent" runat="server">
    Sage -
    <%=Html.Resource(SSO.TitleRegister)%>
</asp:Content>
    ...
    <div id="bodyContainerBare">
        ...
        <div id="breadcrumb">
            <span class="breadItem">
                <%= Html.Encode(Model.WebApplicationDisplayName)%></span>&nbsp;/&nbsp;<span class="breadItemSelected"><%= Html.Resource(Resources.SSO.TitleRegister)%></span>
        </div>
        ...
        <div id="contentBorder">
            <div id="content">
                ...
                <div id="contentOneCol">
                    ...
                    <div>
                        <fieldset>
                            <legend><%= Html.Resource(Resources.SSO.TitleAccountInformation) %></legend>
                            <% Html.SSO(SSOWidget.RegisterValidationSummary); %>                      
                            <p>
                                <% Html.SSO(SSOWidget.Email, new { tooltip = true }); %>
                            </p>
                            <p>
                                <% Html.SSO(SSOWidget.DisplayName, new { tooltip = true }); %>
                            </p>                                                   
                            <p>
                                <% Html.SSO(SSOWidget.Password, new { tooltip = true }); %>
                            </p>
                            <p>
